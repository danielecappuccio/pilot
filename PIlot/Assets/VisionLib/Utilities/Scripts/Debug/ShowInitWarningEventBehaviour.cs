...
public class ShowInitWarningEventBehaviour : MonoBehaviour
{
        ...
        VLTrackingIssues.VLTrackingIssue issue)
    {
        ...
        case 5:
            return "Camera may be removed or used by another process";
        case 10:
        ...
        case 402:
            return "The data path " + issue.info + " doesn't comply with the expected pattern `nodeName.dataName`";
        case 403:
            {
                string[] infoParts = issue.info.Split(
                    new string[] { " :: " },
                    System.StringSplitOptions.None);
                return "Could not find the input " + infoParts[1] + " of the node " + infoParts[0] + "; Possible values: " + infoParts[2];
            }
        case 404:
            {
                string[] infoParts = issue.info.Split(
                    new string[] { " :: " },
                    System.StringSplitOptions.None);
                return "Could not find the output " + infoParts[1] + " of the node " + infoParts[0] + "; Possible values: " + infoParts[2];
            }
        case 405:
            return "There is a cycle in the graph - so no order of execution could be determined";
        case 406:
            return "There was no tracker defined";
        case 407:
