...
public class VLTrackingCameraBehaviour : VLWorkerReferenceBehaviour
{
    /// <summary>
    ...
    {
        if (!extrinsicData.GetModelViewMatrix(this.modelViewMatrixArray) || !this.InitWorkerReference())
        {
            return;
        }
    ...
    private void OnIntrinsicData(VLIntrinsicDataWrapper intrinsicData)
    {
        ...
        if (intrinsicData.GetProjectionMatrix(
            ...
            Screen.width, Screen.height, renderRotation, 0,
