...
/// a given environment can be obtained by calling VLUnityCameraHelper.GetRotationMatrix.
/// </summary>
public enum VLRenderRotation
{
    CCW0 = 0,
    CCW90 = 2,
    CCW180 = 1,
...
public class VLIntrinsicDataWrapper: IDisposable
{
    ...
    /// <summary>
    ///  Legacy interface receiving ScreenOrientation parameter (c.f. VLUnityCameraHelper.GetRenderRotation).
    ///  Use method overload receiving a VLRenderRotation instead.
    /// </summary>
    [Obsolete("Use method overload receiving a VLRenderRotation instead")]
    public bool GetProjectionMatrix(float nearFact,
                                float farFact,
                                int screenWidth,
                                int screenHeight,
