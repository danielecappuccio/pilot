 ...
 * of tracking.
 */
FOUNDATION_EXPORT @interface vlModelProperties:NSObject {
@public
 ...
 * @param command A NSString holding the attributename.
 ...
 * @discussion Set a certain attribute in the pipeline
 * This only works, when the actual pipe has the attribute.
 * @param command An NSString holding the attributename.
